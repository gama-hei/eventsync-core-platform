    ...
    <div className="my-16">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 items-start">
        {speakers.map((speaker) => (
          <div key={speaker.id} className="bg-[#1e232a]/40 border border-slate-800/60 p-4 rounded-xl flex flex-col items-center text-center group hover:bg-[#1e232a] transition-all">
