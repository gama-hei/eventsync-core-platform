    ...
    <div className="max-w-6xl mx-auto px-6 py-12">
      <section className="relative overflow-hidden rounded-3xl bg-[#FBFBFB] border border-gray-100 p-8 md:p-20 mb-20">
        <div className="relative z-10 max-w-2xl">
          ...
          <h2 className="text-2xl md:text-5xl font-serif font-medium bg-red-600 text-black mb-4 leading-tight tracking-tight"></h2>
          ...
          <div className="flex gap-2  ">
            ...
            <p className="text-lg text-gray-500 font-normal mb-10">
              Capacité: {room.capacity} persons
            </p>
          </div>
                                                ...
                                                {session.speakers.map((speaker, idx) => (
                                                    <span key={speaker.id}>
                                                        <Link href={`/speakers/${speaker.id}`}>
                                                            <span className="font-mono text-sm text-gray-600 underline">
                                                                {speaker.fullName}
                                                            </span>
                                                        </Link>
